...
public class MouseEventDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Can we make it to where the text goes wherever we right-click when off screen?
        
        
        // Can you make it to where the text moves *with* the mouse cursor instead of *to* it?
